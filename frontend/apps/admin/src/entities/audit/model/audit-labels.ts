...
export const ACTION_LABELS: Record<string, string> = {
  ...
  'institution.created': '훈련기관 등록',
  'institution.updated': '훈련기관 수정',
  ...
  'trainee.created': '수강생 수기 등록',
  'trainee.grade_changed': '수강생 등급 변경',
  'trainee.updated': '수강생 정보 수정',
  'trainee.deleted': '수강생 삭제',
