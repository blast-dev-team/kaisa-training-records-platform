  ...
  return (
    ...
    >
      ...
      >
        ...
        <tbody>
          <tr>
            <td colSpan={COLS} style={{ height: 96, ...lineStyle({ top: true, left: true }), ...cell }}>
          ...
          <tr>
            <td colSpan={COLS} style={{ height: 48, ...lineStyle({ left: true }), ...cell, fontSize: 15 }}>
              계속교육내역 (최근 3년간)
            </td>
          </tr>
          <tr>
